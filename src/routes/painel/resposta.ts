...
export const ERROS = {
  ...
  sessao_ausente: { status: 401, mensagem: 'Você precisa entrar de novo.' },
  ...
  step_up_necessario: { status: 403, mensagem: 'Confirme com a sua digital para continuar.' },
  dominio_nao_permitido: {
    status: 403,
    mensagem: 'Este endereço não está na lista de endereços liberados.',
  },
  ...
  ultima_passkey: { status: 409, mensagem: 'Cadastre outro aparelho antes de remover este.' },
  ...
  painel_desativado: { status: 503, mensagem: 'O painel ainda não foi ativado.' },
